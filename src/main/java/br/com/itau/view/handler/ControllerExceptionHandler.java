...
import br.com.itau.exception.CustomException;
import br.com.itau.exception.EntityNotFoundException;
import br.com.itau.exception.ServiceException;
import br.com.itau.view.exception.ErrorData;
...
public class ControllerExceptionHandler {
	...
	@ResponseBody
	public ResponseEntity<ErrorResponse> handleSpringRetryableException(final RetryableException ex) {
		final ErrorResponse error = new ErrorResponse(HttpStatus.REQUEST_TIMEOUT.toString(), "timeout", "Serviço indisponível!");
		log.info("RetryableException: {}", error);
